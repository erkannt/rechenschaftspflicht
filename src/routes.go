...
func addRoutes(
	...
	router.GET("/all-events", requireLogin(handlers.AllEventsHandler(queryHandler, auth, logger)))
	router.POST("/mark-event-incorrect", requireLogin(handlers.MarkEventIncorrectPostHandler(cmdHandler, auth, logger)))
